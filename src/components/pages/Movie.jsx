...
export const Movie = () => {
    ...
    const search = (query) => {
        fetch(`https://api.themoviedb.org/3/search/movie?api_key=4dce5e2aa071cda3c95daac64628defc&query=${query}&page=1&language=ko-KR`)
    ...
    useEffect(() => {
        ...
        fetch("https://api.themoviedb.org/3/movie/popular?api_key=4dce5e2aa071cda3c95daac64628defc&language=ko-KR&page=1")
            .then(response => response.json())
